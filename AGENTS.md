...
- No hay suite de tests permanente; es frontend estático. La validación de la lógica se hizo con un arnés temporal (`test.html`, ya eliminado) en Firefox headless: 48 checks de mapa, colisión, prompt, actividad, traza y tema — todos OK.
